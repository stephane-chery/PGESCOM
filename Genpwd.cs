...
namespace PGESCOM
{
    class Genpwd
    {
        ...
        public Genpwd(bool includeLowercase, bool includeUppercase, bool includeNumbers, bool includeSpecial, int passwordLength)
        {
            ...
            if (includeLowercase) characterSet.Append(LOWERCASE_CHARACTERS);
            if (includeUppercase) characterSet.Append(UPPERCASE_CHARACTERS);
            if (includeNumbers) characterSet.Append(NUMERIC_CHARACTERS);
        ...
        public static class PasswordGenerator
        {
            ...
            public static string GeneratePassword(Genpwd settings)
            {
                ...
                for (int characterPosition = 0; characterPosition < settings.PasswordLength; characterPosition++)
                {
                    ...
                    bool moreThanTwoIdenticalInARow = characterPosition > MAXIMUM_IDENTICAL_CONSECUTIVE_CHARS && 
            ...
            public static bool PasswordIsValid(Genpwd settings, string password)
            {
