...
namespace PGESCOM
{
    class ed_LVmodif : ListView
    {

        #region The RECT structure
		/// <summary>
        /// List View created in Forms must be: View property should be Detail && FullRowSelect property should be true 
        ...
        /// <summary>
        /// delete all editable cells (done by edebbab on 13/05/2008)
        /// </summary>
        public void DelALL_EditableCell()
        {
            // Add the cell into the hashtable
            // Value is setting as null because it is an editable cell
			...
			try
			{
				...
				if( this.row != -1 && this.col != -1 )
				{
					...
					if( cell != null)
					{
                        ...
                        Size sz = new Size(this.Columns[col].Width, 14);  //ede modifies : Size sz = new Size(this.Columns[col].Width, Items[row].Bounds.Height); 
