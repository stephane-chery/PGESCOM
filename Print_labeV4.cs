...
namespace PGESCOM
{
	...
	//	private	Word.Application app=new Word.ApplicationClass();
		...
		public Print_labeV4(char x_doctype,string x_lbl1,string x_lbl2,string x_lbl3,string x_prtNme,Order x_ORFrm,QuoteV4  x_QFrm)
		{
			In_ORFrm=x_ORFrm;
			In_QFrm=x_QFrm;
