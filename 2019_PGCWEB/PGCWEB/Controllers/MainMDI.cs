...
namespace PGCWEB
{
  ...
  //      public static string stXP = "", stMsgXP = "";
        ...
        static string DBusrNm = "sa";
          private static string dbpwd = "darasam", SQLDB = @"(localdb)\MyInstance", currDB = "Orig_PSM_FDB";
   ...
   //     public static string C_Style = "103";
    //    public static int myCFID=0;
        ...
        public static string init_Dict()
        {
            ...
            SqlConnection OConn = null;
            bool res = true;
            for (int i = 0; i < 200; i++) for (int j = 0; j < 3; j++) arr_EFSdict[i, j] = "";
            string msgerror = "";
            try
            {
        ...
        {
            string noerrmsg = "";
            ExecSql("INSERT INTO PSM_JFS ([stsql],[dateOpera],[userNm]) VALUES ('" + stSql.Replace("'", ".") + "', " + MainMDI.SSV_date(System.DateTime.Now.ToShortDateString()) + ", '" + usr + "')",ref noerrmsg);
        }
