...
//Configo2
                HttpContext.Session["opera"]="";
               HttpContext.Session["qtnb"] = "";
                HttpContext.Session["pgcid"] = "";
            ...
            else
            {
                ...
                switch (mdul.TrimEnd())
                {
                    ...
                    case "C--":
                        ...
                        if (cpny=="77") return RedirectToAction("xprs_Disp_Steps_view", "Cedule");
                        else     return View("~/Views/Cedule/cedulemnu.cshtml");
