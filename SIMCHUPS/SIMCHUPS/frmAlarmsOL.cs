...
namespace SIMCHUPS
{
    public partial class frmAlarmsOL : Form
    {
        ...
        void fill_Alarms()
        {
            ...
            for (int t = 0; t < 29; t++) btnTXT[t] = MainM.alarms_OneList[t, 0] + ":" + deco_Prop(MainM.alarms_OneList[t, 1]);
        ...
        void cliQBtn(int b)
        {
            ...
            //    MessageBox.Show("alarm= " + btnTXT[ curr_XPTR]  + "       ===curPTR:" + curr_XPTR.ToString()); 
                ...
                for (int bb = 2, v = 0; bb < 12; bb++, v++) V_btnTXT[v] = MainM.alarms_OneList[curr_XPTR, bb];
            if (V_btnTXT[0] != " ")
            {
                frmAlarms_values myfrm = new frmAlarms_values(2, in_OA, MainM.alarms_OneList[curr_XPTR, 0], V_btnTXT, curr_XPTR);
                this.Hide();
                myfrm.ShowDialog();
                ...
                {
                    btnTXT[0] = MainM.alarms_OneList[curr_XPTR, 0] + ":" + deco_Prop(MainM.alarms_OneList[curr_XPTR, 1]);
                    update_Btns(b);
                    this.Visible = true;
                }
            }
