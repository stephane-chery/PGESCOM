...
namespace SIMCHUPS
{
    public partial class frmAlarms_edit_Val : Form
    {
        string in_enterMSG = "?????", in_OA = "?????A", in_Title = "------", in_val = "", in_Enter = "Enter ", in_etat = "", in_unit="";
        bool in_ONOFF=false;

        string stin = "", settingPWD = "1";//settingPWD = "123213";//
        public frmAlarms_edit_Val(string x_Title ,string x_enterMSG,string x_val,string x_unit,string x_etat)
        {
            InitializeComponent();
            in_Title = x_Title;
        ...
        private void bOK_Click(object sender, EventArgs e)
        {
            ...
            lNewV.Text = nval;
                Confirm_value myfrm = new Confirm_value ( in_Title,in_val,nval );
                this.Hide();
                myfrm.ShowDialog();
                this.Visible = true;
        ...
        private void frmAlarms_edit_Val_Load(object sender, EventArgs e)
        {
            ...
            btnPWD.Text = in_Enter +in_enterMSG;
