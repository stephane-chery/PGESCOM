...
namespace SIMCHUPS
{
    public partial class frmAlarms_others : Form
    {
   ...
   //     string[,] alarmsPart1 = new string[8, 12] {
//{"Battery High Volt"," |3|V|(ON)","Value|3|V|(ON)","Differential|3|%| ","Time Delay|75|S| ","Relay|30| | ","Led|6672| | ","Latch Relay| | |(OFF)","Latch Message| | |(ON)","Logic|(Not Fail Safe)| | ","Alarm Common| | |(OFF)","Alarm Priority|Major| | "}, 
//{"Battery Low Volt"," |0.4|V|(ON)"," "," "," "," "," "," "," "," "," "," "},
//{"GND-"," |0|(mA)|(ON)",         " "," "," "," "," "," "," "," "," "," "},
//{"GND+"," |8.5|(mA)|(ON)",       " "," "," "," "," "," "," "," "," "," "},
//{"Rectifier Fail"," | | |(ON)",       " "," "," "," "," "," "," "," "," "," "},
//{"AC Fail"," | | |(ON)",              " "," "," "," "," "," "," "," "," "," "},
...
//                                                  };
        ...
        private void frmAlarms_others_Load(object sender, EventArgs e)
        {
        ...
        void cliQBtn(int b)
        {
            ...
            if (MainM.alarmsPart2[curr_XPTR, 2] != " ")
            {
                    ...
                    {
                        if (MainM.alarmsPart2[curr_XPTR, bb][0] != ' ') V_btnTXT[v] = MainM.alarmsPart2[curr_XPTR, bb];
                    }
                    if (V_btnTXT[0] != " ")
                    {
                        frmAlarms_values myfrm = new frmAlarms_values(2, in_OA, MainM.alarmsPart2[curr_XPTR, 0], V_btnTXT, curr_XPTR);
                        this.Hide();
                        myfrm.ShowDialog();
                        ...
                        {
                            btnTXT[curr_XPTR] = MainM.alarmsPart2[curr_XPTR, 0] + ":" + deco_Prop(MainM.alarmsPart2[curr_XPTR, 1]);
                            update_Btns(b);
                            updated = true;
                            this.Visible = true;
                        }
