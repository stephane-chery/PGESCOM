...
namespace PGESCOM
{
	...
	public class FichWord
	{
        ...
        //public FichWord(QuoteV3 x_Qfrm, FichWord_Config x_FWConfig)
        //{
            //In_QFrm = x_Qfrm;
        ...
        {
            return "_" + MainMDI.User + "_" + DateTime.Now.Year.ToString() + MainMDI.A00(DateTime.Now.Month, 2) + 
                MainMDI.A00(DateTime.Now.Day, 2) + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString();
        }
        ...
        private string newtmpWF(string _Tfn, string docfile, string abrv, ref string errmsg)
        {
            ...
            try
            {
                string newtmpfile = "_" + MainMDI.User + "_" + DateTime.Now.Year.ToString() + MainMDI.A00(DateTime.Now.Month, 2) + 
                    MainMDI.A00(DateTime.Now.Day, 2) + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString();
        ...
        public bool Wexport()
		{
			...
			string Ofn = @MainMDI.WQfiles + @"\Q" + In_QFrm.tQuoteID.Text + stRev + 
                In_QFrm.lCpnyName.Text.Replace("/", " ").Replace(".", "").Replace("'", "_") + ".doc";
		...
		private void OpenWF(string TfName, string OfName)
		{
			...
			app.Documents.Open(ref filename, ref confirmConversions, ref readOnly, ref addToRecentFiles, ref passwordDocument, 
                ...
                ref visible, ref openConflictDocument, ref openAndRepair, ref documentDirection, ref xmlTRsfrm); //, ref noEncodingDialog);
        ...
        */
        ...
        {
            for (int t = 0; t < 20; t++) 
                for (int j = 0; j < 4; j++) arr_terms[t, j] = "";
            int TT = 0;
            string msg = MainMDI.arr_EFSdict[31, MainMDI.Lang];
            WPmsg(msg + " \n", 'B', true, true);
            //WPmsg(msg + \n, 'B', false);
			...
			{ 
				if (In_FC.lvPTC.Items[i].Checked)
				{
					...
					else
					{
						...
						{
							WPrint4PTC('N', In_FC.lvPTC.Items[i].SubItems[0].Text, In_FC.lvPTC.Items[i].SubItems[subNdx].Text, 
                                In_FC.lvPTC.Items[i].SubItems[subNdx + 1].Text, In_FC.lvPTC.Items[subNdx + 2].SubItems[subNdx + 2].Text, 
                                288, 144, 144);
							newP = false;
						}
						else WPrint4PTC('C', In_FC.lvPTC.Items[i].SubItems[0].Text, In_FC.lvPTC.Items[i].SubItems[subNdx].Text, 
        ...
        void Inser_PDF_links()
        {
            if (MainMDI.Lang == 0)
            {
                ...
                WPlinks("https://primaxpower.com/wp-content/uploads/pamphlet/P4600-en.pdf", 
                    "https://primaxpower.com/wp-content/uploads/pamphlet/P4600-en.pdf", 'r', false, false);

                WPmsg("\n" + "P600 EZ-Swap chargers: ", 'r', false, false);
                WPlinks("https://primaxpower.com/wp-content/uploads/P600e-ezswap-30-1.pdf", 
                    "https://primaxpower.com/wp-content/uploads/P600e-ezswap-30-1.pdf", 'r', false, false);

                WPmsg("\n" + "P600 Hot-Swap chargers: ", 'r', false, false);
                WPlinks("https://primaxpower.com/wp-content/uploads/P600eHotEz5.pdf", 
                    "https://primaxpower.com/wp-content/uploads/P600eHotEz5.pdf", 'r', false, false);

                WPmsg("\n" + "P850 UPS and inverters: ", 'r', false, false);
                WPlinks("https://primaxpower.com/wp-content/uploads/pamphlet/P850-en.pdf", 
                    "https://primaxpower.com/wp-content/uploads/pamphlet/P850-en.pdf", 'r', false, false);
            }
            else
            {
                WPmsg("Chargeurs P4600: ", 'r', false, false);
                WPlinks("https://primaxpower.com/wp-content/uploads/pamphlet/P4600-fr.pdf", 
                    "https://primaxpower.com/wp-content/uploads/pamphlet/P4600-fr.pdf", 'r', false, false);

                WPmsg("\n" + "Chargeurs P600 Hot swap et EZ-Swap: ", 'r', false, false);
                WPlinks("https://primaxpower.com/wp-content/uploads/pamphlet/P600-fr.pdf", 
                    "https://primaxpower.com/wp-content/uploads/pamphlet/P600-fr.pdf", 'r', false, false);
        ...
        private void Print_Rev_good()
		{
			...
			while (Oreadr.Read())
			{
                ...
                if (Desc[0] !='_')
				{
                    ...
                    //P4600 Hidden Item
                    string H_itemP4600TXT= (MainMDI.Lang == 0) ? @"PC23 c/w touch screen, P4600 overlay and cabinet door cutout" : 
                    ...
                    if (Oreadr["Q_tec_Val"].ToString() != "C_HIDE" || H_itemP4600)
					{
						if (Oreadr["Aff_ID"].ToString() == " " || H_itemP4600)
						{
							...
							if (iPos > 0) WPrint2Col(tbl, qty + Desc.Substring(0, iPos) + ": ", Desc.Substring(iPos + 2, 
                                Desc.Length - iPos - 2), WT_1Col, WT_2Col);
                ...
                if (Desc[0] != '_')
                {
                    ...
                    if (Oreadr["Q_tec_Val"].ToString() != "C_HIDE" || H_itemP4600)
                    {
                        if (Tools.Conv_Dbl(Oreadr["Aff_ID"].ToString()) > 0)
                        {
                            ...
                            WPrint6Col('C', "", Oreadr["Aff_ID"].ToString() + ". " + Desc, Oreadr["QTY"].ToString(), "1", 
                                Oreadr["Uprice"].ToString(), Oreadr["Ext"].ToString());
        ...
        */
        ...
        private void Page_UPS()
        {
            ...
            //int subNdx = (In_FC.chkAGP.Checked) ? 4 : 1;
            for (int i = 0; i < nbItem; i++) WPrint3Col('Q', In_FC.lvUPS.Items[i].SubItems[0].Text, In_FC.lvUPS.Items[i].SubItems[1].Text, 
                In_FC.lvUPS.Items[i].SubItems[2].Text, 300, 100, 60);
        }
        ...
        * *****************************************************/
        ...
        int QT_fill_XL_Header()
        {
            ...
            for (int i = 0; i < VQ_Lines; i++) 
                for (int j = 0; j < VQ_Cols; j++) arr_VQ[i, j] = "";
        ...
        private void XL_EXPORT_Image(string FName, object[] objHdrs, int HdrsNB, string CellFM, string CellTO, object[,] objData)
        {
            ...
            m_objSheet.Shapes.AddPicture(MainMDI.XL_Path + "\\primax.JPG", Microsoft.Office.Core.MsoTriState.msoFalse, 
                Microsoft.Office.Core.MsoTriState.msoCTrue, 10, 10, 200, 40);
