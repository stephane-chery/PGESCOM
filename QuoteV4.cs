...
namespace PGESCOM
{
    public partial class QuoteV4 : Form
    {
        char TV_RSA = 'V';
  //    public  string lCurSoln.Text = "",lCurINDX_Text="",lcurSol_Status.Text="",lOFName.Text="",lCurALSn.Text="", lCurSolNDX.Text="";
   ...
   //     string  disp_solID_Text = "", disp_altID_Text = "", disp_alsID_Text = "";
        ...
        public QuoteV4(long x_QID, string x_CpnyName, char x_opera)
		{
			//
          ...
          //  MainMDI.M_stCon = MainMDI.M_stCon ;
			...
			//		for (int i=0;i<toolBar1.Buttons.Count;i++)    toolBar1.Buttons[i].Enabled   =false;
                    ...
                    for (int i = 0; i < toolBar1444.Items.Count; i++) toolBar1444.Items[i].Enabled = false;
...
*/
        ...
        */
        ...
        int toolbar1_btName_ndx(string Name)
        {
            ...
            for (int t=0;t<toolBar1444.Items.Count ;t++)
                if (toolBar1444.Items[t].Text == Name)
                {
                    ndx = t;
                    t = toolBar1444.Items.Count;
                }
        ...
        private void tabControl1_SelectedIndexChanged(object sender, System.EventArgs e)
        {
           ...
           {
               SAVE_CHANGE_ALS();
               toolBar1444.Items[19].Visible = (!Tosave);
               xpndd.Visible = true; 
               if (lCurr_opera.Text == "E" || lCurr_opera.Text == "N")
               {
                   if (!Quote_loaded)
                   {
                       ...
                       tvSol.Nodes.Clear();
                       fill_Sol();
                       toolBar1444.Items[19].Visible = true;
                       if (tvSol.Nodes.Count == 0) AlS_Wizard();
                   }
               }
               if (lcurIMAGE != -1) aff_ICNS(lcurIMAGE);  
           }
           else
           {
               ...
               toolBar1444.Items[19].Visible = (tabControl1.SelectedIndex == 1);
        ...
        private void switch_ToolBar(int c)
        {
            if (in_opera != 'C')
            {
                for (int i = 0; i < toolBar1444.Items.Count - 1; i++)
                {
                    switch (c)
                    {
                        case 0:
                            toolBar1444.Items[i].Visible =false;// (i < lim0);
                            toolBar1444.Items[19].Visible = true;
                            toolBar1444.Items[3].Visible = true;
                            break;

                        case 1:
                            toolBar1444.Items[i].Visible = (i < lim1 && i >= lim0);
                            toolBar1444.Items[19].Visible = true;
                            break;
                        case 2:
                            toolBar1444.Items[i].Visible = false;
                            toolBar1444.Items[19].Visible = true;
                            break;
                        case 9:
                            toolBar1444.Items[i].Visible = (i < lim2 && i >= lim1);
                            toolBar1444.Items[20].Visible = true;
                            break;
                    }
        ...
        private void tvSol_AfterSelect_OLDV2(object sender, System.Windows.Forms.TreeViewEventArgs e)
        {
            this.Cursor = Cursors.WaitCursor;
            ...
            switch (tvSol.SelectedNode.ImageIndex)
            {
                ...
                case 1:   // Spec
                    ...
                    toolBar1444.Items[4].Enabled = false;
                    printALS.Visible = false;
                    toolBar1444.Items[5].Enabled = false;
                    toolBar1444.Items[6].Enabled = true;
                    lCurSolNDX.Text = tvSol.SelectedNode.Parent.Index.ToString();
                    lCurSPCNDX.Text = tvSol.SelectedNode.Index.ToString();
                    switch_ToolBar(1);
                    AlsTOT_orig.Text = "";
                ...
                case 4:
                    ...
                    switch_ToolBar(1);
                    printALS.Visible = false;
                    toolBar1444.Items[4].Enabled = true;
                    toolBar1444.Items[5].Enabled = true;
                    toolBar1444.Items[6].Enabled = false;  //disable ADD-ALIAS
                    toolBar1444.Items[7].Enabled = true;
                    lCurSolNDX.Text = tvSol.SelectedNode.Index.ToString();
                    //	tALSnb.Text ="1"; 
                    AlsTOT_orig.Text = "";
                    tAGprice.Text = "";
...
//new Agents use 20052015
 ...
 //new Agents use 20052015
        ...
        //#        if (toolBar1.Buttons[16].Pushed)
                if (toolBar1444.Items[16].Pressed ) //   .Checked )
                {
...
*/
        ...
        */
        ...
        private void lvQITEMS_ColumnClick(object sender, System.Windows.Forms.ColumnClickEventArgs e)
        {
            ...
            MessageBox.Show("desc: " + lvQITEMS.Columns[2].Width.ToString());
    ...
    */
        ...
        private void printQSum()
        {
            ...
            if (lvQITEMS.Items.Count > 0)
            {
                ...
                //string prtNmeOLD= printDialog1.PrinterSettings.PrinterName;
                string prtNme = MainMDI.DYMOName;
                Print_labeV4 ll = new Print_labeV4('Q', "*", "*", "*", prtNme, null,this);
                ll.Wexport();
                MainMDI.OpenKnownFile(lOFName.Text);
...
//must be added to quotIII 
        ...
        void find_Sys_RevNN(string Ilrev, string[] Sys )
    {
        ...
        void Reorder_ALT()
          ...
          {
              //  int btn = toolBar1.Buttons.IndexOf(e.Button);
              for (int i = 0; i < toolBar1444.Items.Count - 2; i++) toolBar1444.Items[i].Visible = false;
                xpndd.Visible = true;
                ...
                switch (levl)
                {
                    ...
                    case 2:
                        ...
                        Print.Visible = true;
                        tlsOalt.Visible = true;
                        tlsOrev.Visible = true;
                        //  Print.Visible = true;
                        break;
                    case 1:
                        //    AddAls.Visible = true;
                        ...
                        tlsOsys.Visible = true;
                        tlsddNsys.Visible = true;
          ...
          private void QuoteV4_Load(object sender, EventArgs e)
          {
              Size_LVITEMS();
              LoadQuote();
          }
          ...
          private void tlsOrev_Click(object sender, EventArgs e)
          {
              Reorder_REV();
          }

          private void tlsOalt_Click(object sender, EventArgs e)
          {
              Reorder_ALT();
          }

          private void tlsOsys_Click(object sender, EventArgs e)
          {
              Reorder_Systems();
          }

          private void tlsDiagram_Click(object sender, EventArgs e)
          {
              Display_SYSdiagram();
          }
          ...
          void Display_SYSdiagram()
          {

              Q_Single mysingle = new Q_Single(this, lCurSPCn.Text ,lCurALSn.Text );
              this.Hide();
              mysingle.ShowDialog();
              this.Visible = true;
          ...
          void New_SYSdiagram()
          {
              lCurrNAME.Text = MainMDI.arr_EFSdict[38, MainMDI.Lang] + "#" + Convert.ToString(tvSol.SelectedNode.Nodes.Count + 1);
              if (LBL_Exist_Newa(lCurrNAME.Text)) lCurrNAME.Text = MainMDI.arr_EFSdict[38, MainMDI.Lang] + "#" + Convert.ToString(tvSol.SelectedNode.Nodes.Count + 1);
              Q_Single mysingle = new Q_Single(this,lCurSPCn.Text, lCurrNAME.Text);
              this.Hide();
              mysingle.ShowDialog();
              this.Visible = true;
          ...
          {
              if (MainMDI.ALWD_USR("QT_SV", true)) addBlankSystem();
          }
        ...
        void addBlankSystem()
          ...
          private void HidItm_Click(object sender, EventArgs e)
          {
              //if (MainMDI.ALWD_USR("QT_SV", true)) Tollsbar_CLicK(toolbar1_btName_ndx(sender.ToString()));
              th_nb.Text = (ItemCount + 1).ToString();
              th_SYS.Text = AlsTOT_orig.Text;
