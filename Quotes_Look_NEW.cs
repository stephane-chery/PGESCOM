...
namespace PGESCOM
{
    ...
    /// </summary>
    public class Quotes_Look_NEW : System.Windows.Forms.Form
	{
        //threads
        bool killseek = false;
        Thread m_WkTHRD;
        ...
        private ToolStripDropDownButton tlsNewPL;
        private ToolStripMenuItem newQuoteToolStripMenuItem;
        private ToolStripMenuItem openSelectedQuoteToolStripMenuItem;
        private System.ComponentModel.IContainer components;

		public Quotes_Look_NEW(char x_c)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Quotes_Look_NEW));
            ...
            this.tlsNewPL = new System.Windows.Forms.ToolStripDropDownButton();
            this.openSelectedQuoteToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.toolBar1.Size = new System.Drawing.Size(877, 64);
            ...
            this.grpFindqq.Size = new System.Drawing.Size(1561, 81);
            ...
            this.TSmain.Size = new System.Drawing.Size(1555, 57);
            ...
            this.newQ.Name = "newQ";
            this.newQ.Size = new System.Drawing.Size(82, 50);
            ...
            this.findQ.Size = new System.Drawing.Size(80, 50);
            ...
            this.ConvertQ.Size = new System.Drawing.Size(118, 50);
            ...
            this.toolStripButton1.Size = new System.Drawing.Size(112, 50);
            ...
            this.Q3.Name = "Q3";
            this.Q3.Size = new System.Drawing.Size(111, 50);
            this.Q3.Text = "   Quote Testing";
            ...
            // tlsNewPL
            // 
            this.tlsNewPL.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.openSelectedQuoteToolStripMenuItem,
            this.newQuoteToolStripMenuItem});
            this.tlsNewPL.ForeColor = System.Drawing.Color.Red;
            this.tlsNewPL.Image = ((System.Drawing.Image)(resources.GetObject("tlsNewPL.Image")));
            this.tlsNewPL.ImageTransparentColor = System.Drawing.Color.Magenta;
            this.tlsNewPL.Name = "tlsNewPL";
            this.tlsNewPL.Size = new System.Drawing.Size(151, 50);
            this.tlsNewPL.Text = "New Price List Quote";
            this.tlsNewPL.TextImageRelation = System.Windows.Forms.TextImageRelation.ImageAboveText;
            this.tlsNewPL.Visible = false;
            this.tlsNewPL.Click += new System.EventHandler(this.toolStripDropDownButton1_Click);
            // 
            // openSelectedQuoteToolStripMenuItem
            // 
            this.openSelectedQuoteToolStripMenuItem.Name = "openSelectedQuoteToolStripMenuItem";
            this.openSelectedQuoteToolStripMenuItem.Size = new System.Drawing.Size(206, 22);
            this.openSelectedQuoteToolStripMenuItem.Text = "Open selected quote";
            this.openSelectedQuoteToolStripMenuItem.Click += new System.EventHandler(this.openSelectedQuoteToolStripMenuItem_Click);
            // 
            // newQuoteToolStripMenuItem
            // 
            this.newQuoteToolStripMenuItem.Name = "newQuoteToolStripMenuItem";
            this.newQuoteToolStripMenuItem.Size = new System.Drawing.Size(206, 22);
            ...
            this.NewQ3.Size = new System.Drawing.Size(151, 50);
            ...
            this._exit.Size = new System.Drawing.Size(58, 50);
            ...
            this.SyncLBL.Size = new System.Drawing.Size(102, 14);
            ...
            this.lxtt.Name = "lxtt";
            this.lxtt.Size = new System.Drawing.Size(89, 34);
            ...
            this.btnseek.Location = new System.Drawing.Point(602, 15);
            ...
            this.grpFind.Size = new System.Drawing.Size(1561, 102);
            ...
            this.button1.Location = new System.Drawing.Point(933, 21);
            ...
            this.lvQuotes.Size = new System.Drawing.Size(1561, 573);
        ...
        private void LookQuotes_Load(object sender, System.EventArgs e)
        {
            ...
            //tlsNewPL.Visible = (MainMDI.User == "edtst" || MainMDI.User == "ede" || MainMDI.User == "mbyad" || MainMDI.User == "hnasrat");
        }
        ...
        //{
            ...
            ////}
            //if (lvQuotes.SelectedItems.Count == 1) OpenQuote4();
        ...
        void OpenQuote3()
        {
            ...
            if (lvQuotes.SelectedItems.Count > 0)
            {
                edit_Quote3(lvQuotes.SelectedItems[0].SubItems[0].Text, lvQuotes.SelectedItems[0].SubItems[2].Text);
                ref_QList(lvQuotes.SelectedItems[0].SubItems[4].Text, lvQuotes.SelectedItems[0].Index);
            }
            this.Cursor = Cursors.Default;
        }
        ...
        private void edit_Quote3(string QNB, string CpnyName)
        {
            if (MainMDI.User == "ede")
            {
                MainMDI.ExecSql("UPDATE PSM_users_New  SET [inuse]='0' where [user]='Admin'");
            ...
            if (usr == MainMDI.VIDE || MainMDI.User == "ede")
            {
                ...
                char c = (QNB == "0") ? 'N' : 'E';
                int ndx = lvQuotes.SelectedItems[0].Index;
                QuoteV3 child3 = new QuoteV3(Convert.ToInt32(QNB), CpnyName, c);
                this.Hide();
                child3.ShowDialog();
                this.Visible = true;
                if (child3.lSave.Text == "S")
                {
                    lvQuotes.Items[ndx].SubItems[0].Text = child3.tQuoteID.Text;
                    string dat = child3.tOpendate.Text;
                    lvQuotes.Items[ndx].SubItems[1].Text = MainMDI.frmt_date(dat); //dat.Substring(6, 4) + "/" + dat.Substring(3, 2) + "/" + dat.Substring(0, 2);
                    lvQuotes.Items[ndx].SubItems[2].Text = child3.lCpnyName.Text;
                    lvQuotes.Items[ndx].SubItems[3].Text = child3.tProjNAME.Text;
                }
                MainMDI.Use_QRID(0, 'Q', lvQuotes.SelectedItems[0].SubItems[4].Text);
                child3.Dispose();
            }
        ...
        private bool CustomerNOTinBL(string cpnyName)
        {
            ...
            MainMDI.Find_2_Field("select BLack_List,  BL_Cmnt, BL_usr  from PSM_COMPANY Where Cpny_Name1='" + cpnyName.Replace("'", "''") + "'", ref InBL, ref BLcmnt, ref usr);
        ...
        bool QT_Req_exist()
        {
            string res = MainMDI.Find_One_Field("select  Quot_Req from PSM_Q_IGen where i_Quoteid=" + lvQuotes.SelectedItems[0].SubItems[4].Text);
                ...
                switch (btn)
                {
                    ...
                    case 5: //Convert Quote To Order
                        if (MainMDI.PermT_user("RS"))
                        {
                            ...
                            else MessageBox.Show("Can not CONVERT This quote since Quotation Customer is Empty .....\n Pls. open this Quote and click the BIG BLUE button )");
                        }
        ...
        private void Q3_Click(object sender, EventArgs e)
        {
            ...
            //edit_Quote3("15999", "Société Québécoise d'Assainiss");
            //ref_QList("", 4);
        }
        ...
        private void openSelectedQuoteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //if (lvQuotes.SelectedItems.Count == 1) OpenQuote4();
            //else MessageBox.Show("Please select a quote.....");
        }
