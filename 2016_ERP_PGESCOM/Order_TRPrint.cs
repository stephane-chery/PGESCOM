		...
		private void Print2L_EQ_AL_OT()
		{
			...
			{ 
				...
				{			
					...
					WPrint10Cols('R',(ar_EQ_AL_TST[i,0]=="8"),ar_EQ_AL_TST[i,1],ar_EQ_AL_TST[i,2],ar_EQ_AL_TST[i,4],ar_EQ_AL_TST[i,6],ar_EQ_AL_TST[i,8],ar_EQ_AL_TST[i,10],ar_EQ_AL_TST[i,12] ,ar_EQ_AL_TST[i,14],ar_EQ_AL_TST[i,16]);
					//print Tested values 
					...
					WPrint10Cols('T',(ar_EQ_AL_TST[i,0]=="8"),ar_EQ_AL_TST[i,1],ar_EQ_AL_TST[i,3],ar_EQ_AL_TST[i,5],ar_EQ_AL_TST[i,7],ar_EQ_AL_TST[i,9],ar_EQ_AL_TST[i,11],ar_EQ_AL_TST[i,13] ,ar_EQ_AL_TST[i,15],ar_EQ_AL_TST[i,16]);
				}
				else break;
			}
		}
	...
	//		MessageBox.Show("NL=  " + NL.ToString()  ); 
		...
		private void Print_Head_Info()
		{
			...
			if (In_RDR.lbrdNm.Text !="" && In_RDR.lbrdNm.Text!=MainMDI.VIDE     ) 
			{
				...
				WPmsg("    BoarVer: ",'b',false);WPmsg(In_RDR.lbrdVer.Text   ,'n',false);
