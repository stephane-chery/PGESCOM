...
namespace PGESCOM
{
 ...
 //       private static string dbpwd = "primax";
        ...
        ******************************************/
        ...
        // environment TU
   //     public static string SQLDB = @"PROGRAMEUR1\PERS2000";      //SS23 ok home
 ...
 //      public static string currXMLfile = @"\PGC_config.xml";
        ...
        static string GescomBld = "190823.01"; //YYMMDD.VV   //"60824.00"
        static string RealBld = "190823.01"; //"190620.00"
     ...
     // testing syspro   public static string M_stCon_PL_SYSPRO = @"user id=sa;password=prim@x1;server=ERPSERVER\PGESCOM;Trusted_Connection=No;database=SysproCompanyX;connection timeout=30";
       ...
       // public static string M_stCon_PL_SYSPRO = @"user id=sa;password=haidarprimax2013;server=ERPSERVER\PGESCOM;Trusted_Connection=No;database=SysproCompanyP;connection timeout=30";
		...
		//public  static readonly string M_stCon= @"Provider=Microsoft.Jet.SqlDB.4.0;Data Source=" + Application.StartupPath + "\\" + loc_DB + @" ;Persist Security Info=False";
		...
		private void InitializeComponent()
		{
            ...
            this.new_qt.Size = new System.Drawing.Size(49, 60);
            ...
            this.Orders.Size = new System.Drawing.Size(53, 60);
            ...
            this.arch.Name = "arch";
            this.arch.Size = new System.Drawing.Size(122, 60);
            this.arch.Text = "Old projects (Access)";
            ...
            this.bglst.Size = new System.Drawing.Size(67, 60);
            ...
            this.company.Size = new System.Drawing.Size(71, 60);
            ...
            this.cpts.Name = "cpts";
            this.cpts.Size = new System.Drawing.Size(80, 60);
            ...
            this.cntct.Size = new System.Drawing.Size(58, 60);
            ...
            this.Statistics.Size = new System.Drawing.Size(57, 60);
            ...
            this.SP_REP.Size = new System.Drawing.Size(67, 60);
            ...
            this.ts_acct.Size = new System.Drawing.Size(83, 60);
            this.ts_acct.Text = "Commissions";
            ...
            this.sett.Name = "sett";
            this.sett.Size = new System.Drawing.Size(48, 60);
            ...
            this.pbsizing.Size = new System.Drawing.Size(106, 60);
            this.pbsizing.Text = "Vacations / Events";
            ...
            this.pg_tools.Size = new System.Drawing.Size(57, 60);
            ...
            this.babt.Name = "babt";
            this.babt.Size = new System.Drawing.Size(44, 60);
            ...
            this.exiit.Size = new System.Drawing.Size(77, 60);
            ...
            this.db_used.Size = new System.Drawing.Size(66, 60);
            ...
            this.RnD.Name = "RnD";
            this.RnD.Size = new System.Drawing.Size(76, 60);
            ...
            this.assembliesToolStripMenuItem.Size = new System.Drawing.Size(181, 22);
            ...
            this.componentsSearchToolStripMenuItem.Size = new System.Drawing.Size(181, 22);
    ...
    private string DisplayData(System.Data.DataTable table)
  {
        ...
        void slowingPC()
    {
        ...
        private void MainMDI_LoadOLD_15112015(object sender, System.EventArgs e)
        {
            ...
            sett.Visible = (MainMDI.User.ToLower() == "ede");
        ...
        private void MainMDI_Load_OK30052016(object sender, System.EventArgs e)
        {
            ...
            if (login)
            {
                ...
                picCIP.Visible = !(MainMDI.Env_PROD);// ? false : true;
                sett.Visible = (MainMDI.User.ToLower() == "ede");
                bglst.Visible = (MainMDI.User.ToLower() == "ede");
...
//}
			...
			if (r_stat !=MainMDI.VIDE )
			{
				if (r_stat=="9" ||  r_stat=="8")
				{
					...
					if (MainMDI.User !="ede" && MainMDI.User.ToLower () !="admin" ) 
					{
						...
						//	MessageBox.Show("   \n ALERT \n PGESCOM is being maintenace , Contact Administrator    "," Message ",MessageBoxButtons.OK ,MessageBoxIcon.Stop ); 
						timer2.Interval =10;
						timer2.Enabled =true; 
					}
					...
					if (!timer2.Enabled   ) 
					{
						...
						{   
							...
							*/
							...
							timer2.Interval = (mchnStat=="9") ? 10000 : 120000; 
							int nbSec=(mchnStat=="9") ? 10 : 120; 
							timer2.Enabled =true; 
							timer1.Enabled =false; 
		...
		private void timer2_Tick(object sender, System.EventArgs e)
		{
			...
			{
				InfoBoard frmcntr= new InfoBoard(" PGESCOM will be stopped for maintenance in 10 seconds...",10); 
				frmcntr.ShowDialog(); 
			}
        ...
        private void ts_acct_Click(object sender, EventArgs e)
        {
            ...
            if (MainMDI.ALWD_USR("C_CMS", false) || MainMDI.ALWD_USR("A_CMS", false) || MainMDI.ALWD_USR("V_CMS", false))
            {
                if (!MainMDI.user_Admin() && SRVRpwd!="Y")
                {
                    ...
                    if (MainMDI.User.ToLower() != "mmellouli" && MainMDI.User.ToLower() != "mmaturi")
                    {
