...
namespace PGESCOM
{
	...
	/// </summary>
	public class OR_ToSched : System.Windows.Forms.Form
    {
       //local var
        ...
        public OR_ToSched(string x_RID, string x_IRRevID,string x_CSTMR, char x_EM)
		{
			//
      ...
      //     fill_TVConfigBIG(); 
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(OR_ToSched));
            ...
            this.groupBox3.Size = new System.Drawing.Size(892, 486);
            ...
            this.grpACF.Location = new System.Drawing.Point(737, 16);
            this.grpACF.Name = "grpACF";
            this.grpACF.Size = new System.Drawing.Size(152, 467);
            ...
            this.lvCurConfig.Location = new System.Drawing.Point(3, 76);
            this.lvCurConfig.Name = "lvCurConfig";
            this.lvCurConfig.ShowGroups = false;
            this.lvCurConfig.Size = new System.Drawing.Size(146, 388);
            ...
            this.toolStrip1.Size = new System.Drawing.Size(146, 60);
            ...
            this.tadd.Name = "tadd";
            this.tadd.Size = new System.Drawing.Size(41, 57);
            this.tadd.Text = "Move";
            ...
            // 
            this.hhh.Name = "hhh";
            this.hhh.Size = new System.Drawing.Size(6, 60);
            // 
            // mov
            // 
            ...
            this.mov.Name = "mov";
            this.mov.Size = new System.Drawing.Size(36, 57);
            this.mov.Text = "Add ";
            ...
            this.C_txt.Size = new System.Drawing.Size(240, 23);
            // 
            // groupBox1
            // 
            ...
            this.groupBox1.Size = new System.Drawing.Size(734, 467);
            ...
            this.ed_lvInfo.Location = new System.Drawing.Point(273, 16);
            this.ed_lvInfo.Name = "ed_lvInfo";
            this.ed_lvInfo.Size = new System.Drawing.Size(458, 448);
            ...
            // TDesc
            // 
            this.TDesc.Text = "Task Name / Info.";
            this.TDesc.Width = 132;
            // 
            // Ival
            // 
            ...
            this.tvConfig.Location = new System.Drawing.Point(3, 16);
            this.tvConfig.Name = "tvConfig";
            this.tvConfig.SelectedImageIndex = 0;
            this.tvConfig.Size = new System.Drawing.Size(270, 448);
            ...
            // button2
            // 
            this.button2.Location = new System.Drawing.Point(170, 58);
            ...
            this.grpConf.Size = new System.Drawing.Size(892, 79);
            this.grpConf.TabIndex = 240;
            this.grpConf.TabStop = false;
            // 
            // dpdlvrd
            // 
            this.dpdlvrd.Location = new System.Drawing.Point(787, 33);
            this.dpdlvrd.Name = "dpdlvrd";
            this.dpdlvrd.Size = new System.Drawing.Size(81, 20);
            ...
            this.TSmain.Size = new System.Drawing.Size(886, 60);
            ...
            this.Save.Name = "Save";
            this.Save.Size = new System.Drawing.Size(36, 57);
            this.Save.Text = "Save";
            ...
            this.xpnd.Name = "xpnd";
            this.xpnd.Size = new System.Drawing.Size(64, 57);
            ...
            this.enbleSP.Size = new System.Drawing.Size(46, 57);
            ...
            this.disableSP.Size = new System.Drawing.Size(49, 57);
            ...
            this.Copy.Name = "Copy";
            this.Copy.Size = new System.Drawing.Size(76, 57);
            ...
            this.Past.Name = "Past";
            this.Past.Size = new System.Drawing.Size(70, 57);
            ...
            this.del_prj.Size = new System.Drawing.Size(94, 57);
            ...
            this.sc_exit.Size = new System.Drawing.Size(47, 57);
            ...
            this.lSCDlid.Size = new System.Drawing.Size(0, 57);
            // 
            // OR_ToSched
            // 
     ...
     //       this.Cursor = Cursors.WaitCursor;
            string stSql = " SELECT " + SCD_DETAIL_Name + ".sc_det_LID FROM  PSM_R_SCD_INFO INNER JOIN " + SCD_DETAIL_Name + " ON PSM_R_SCD_INFO.sc_LID = " + SCD_DETAIL_Name + ".d_sc_LID " +
     ...
     ///       dgSched.Refresh();
        ...
        private void New_All_SCD()
        {
            ...
            string stSql = " SELECT   PSM_R_RevSys.R_sysName, PSM_R_CFinfo.c_SN,PSM_R_CFinfo.CFLID, PSM_R_CFinfo.ConfigNm FROM PSM_R_CFinfo INNER JOIN " +
            ...
            while (Oreadr.Read())
            {
                ...
                //seek CFTVA
               stSql = MainMDI.Find_One_Field(" SELECT PSM_R_CFDetail.cf_tecVal FROM  PSM_R_CFDetail INNER JOIN  PSM_R_CFinfo ON PSM_R_CFDetail.d_CFLID = PSM_R_CFinfo.CFLID " +
                               " WHERE     PSM_R_CFinfo.ConfigNm = '" + Ncf + "' AND PSM_R_CFinfo.c_RRevLID =" + in_IRRevID + " AND PSM_R_CFDetail.cf_tecVal LIKE '%C_MODEL||%' ORDER BY PSM_R_CFDetail.d_Rnk ");
        ...
        {
            long  lid=-1;
             string scdID = MainMDI.Find_One_Field(" SELECT sc_LID  FROM PSM_R_SCD_INFO where sc_SysName='" + Nstm + "' and sc_Name='" + Ncf + "' and sc_IREVID=" + in_IRRevID + " and sc_status=1 and sc_CF_LID=" + _dlvD);
        ...
        private void Fill_CurConf(string _cCF,bool fill_lv)
        {
            ...
            string stSql = "SELECT     PSM_R_CFDetail.*, PSM_R_CFinfo.* FROM  PSM_R_CFDetail INNER JOIN  PSM_R_CFinfo ON PSM_R_CFDetail.d_CFLID = PSM_R_CFinfo.CFLID " +
                " WHERE     PSM_R_CFinfo.ConfigNm = '" + _cCF + "' AND PSM_R_CFinfo.c_RRevLID =" + in_IRRevID + " ORDER BY PSM_R_CFDetail.d_Rnk ";
            SqlConnection OConn = new SqlConnection(MainMDI.M_stCon);
            OConn.Open();
            SqlCommand Ocmd = OConn.CreateCommand();
            Ocmd.CommandText = stSql;
            ...
            if (x_TVA.Substring(0, 2) == "S_" || x_TVA.Substring(0, 2) == "C_" || x_TVA.Substring(0, 2) == "B_") 
            {
                switch (x_TVA)
                {
                    ...
                    case "B_":
                        ...
                        break;
                    case "S_SALES":
                            res = MainMDI.Find_One_Field("SELECT PSM_SALES_AGENTS.FL FROM PSM_R_Rev INNER JOIN PSM_Q_IGen ON PSM_R_Rev.iQID = PSM_Q_IGen.i_Quoteid INNER JOIN PSM_SALES_AGENTS ON PSM_Q_IGen.Employ_ID = PSM_SALES_AGENTS.SA_ID " +
                                               " WHERE     PSM_R_Rev.IRRevID =" + in_IRRevID);
                            break;
                    case "S_PRJNB":
                         res= MainMDI.Find_One_Field("SELECT PSM_R_Rev.RID FROM PSM_R_Rev INNER JOIN PSM_Q_IGen ON PSM_R_Rev.iQID = PSM_Q_IGen.i_Quoteid INNER JOIN PSM_SALES_AGENTS ON PSM_Q_IGen.Employ_ID = PSM_SALES_AGENTS.SA_ID " +
                                               " WHERE     PSM_R_Rev.IRRevID =" + in_IRRevID);
                         break;
                    case "S_PONB":
                         res= MainMDI.Find_One_Field("SELECT PSM_R_Rev.Custm_PO FROM PSM_R_Rev INNER JOIN PSM_Q_IGen ON PSM_R_Rev.iQID = PSM_Q_IGen.i_Quoteid INNER JOIN PSM_SALES_AGENTS ON PSM_Q_IGen.Employ_ID = PSM_SALES_AGENTS.SA_ID " +
                                               " WHERE     PSM_R_Rev.IRRevID =" + in_IRRevID);
                         break;
                    case "S_CUSTMR":
                        res = in_CSTMR;
  ...
  //          this.listViewMain.AddComboBoxCell(-1, 1, grades); 
        ...
        private void fill_TVConfig()
        {
            ...
            Ocmd.CommandText = stSql;
            SqlDataReader Oreadr = Ocmd.ExecuteReader();
            while (Oreadr.Read()) tvConfig.Nodes.Add(Oreadr["ConfigNm"].ToString());
            OConn.Close();
        ...
        private void fill_TVConfigBIG()
        {
            ...
            tvConfig.Nodes.Clear();
            lvCurConfig.Items.Clear();
            string stSql = "SELECT sc_SysName , sc_Name, sc_status FROM PSM_R_SCD_INFO WHERE sc_IREVID =" + in_IRRevID + " ORDER BY sc_Name, sc_Rnk "  ;
        ...
        private void tvConfig_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            switch (tvConfig.SelectedNode.ImageIndex)
            {
                ...
                case 3:
                 ...
                 //   }
                    if (tvConfig.SelectedNode.ForeColor != Color.Black)
                    {lvCurConfig.Items.Clear(); ed_lvInfo.Items.Clear(); }
                    break;
            }
        ...
        private void tvConfig_AfterSelectokkk(object sender, TreeViewEventArgs e)
        {
             ...
             switch (tvConfig.SelectedNode.ImageIndex)
             {
                 ...
                 case 3:
                     ...
                     else { lvCurConfig.Items.Clear(); ed_lvInfo.Items.Clear(); }   
                     break;
             }
 ...
 * */
        ...
        private void chk_TVconfig(bool sta)
        {
           ...
           {
                for (int nj = 0; nj < tvConfig.Nodes[ni].Nodes.Count; nj++)
                    tvConfig.Nodes[ni].Nodes[nj].Checked = sta;
           }
        }
        ...
        {
          //  chk_TVconfig(false);
            for (int i = 0; i < 20; i++) for (int j = 0; j < 3; j++)  arr_Tskscopy[i, j] = "";
     ...
     //   }
        ...
        private void xpnd_Click(object sender, EventArgs e)
        {
            ...
            for (int n = 0; n < tvConfig.Nodes.Count; n++)
                if (X)  tvConfig.Nodes[n].Expand(); else  tvConfig.Nodes[n].Collapse();
            xpnd.Text = (X) ? "Collapse all" : "Expand all";
        }

        private void mov_Click(object sender, EventArgs e)
        {
            if (tsk_cur_ndx != -1 && C_txt.Text != "")
                ed_lvInfo.Items[tsk_cur_ndx].SubItems[2].Text += "~~~" + C_txt.Text;
        }
        ...
        private void del_prj_Click(object sender, EventArgs e)
        {
            if (MainMDI.User.ToLower() == "ede" )
            {
                ...
                {
                    MainMDI.Exec_SQL_JFS("delete  PSM_R_SCD_INFO where PSM_R_SCD_INFO.sc_IREVID=" + in_IRRevID, "delete project from SCD_INFO....usr="+MainMDI.User + "  PC=" + MainMDI.Mach_Name    );
                 //   load_ALLCFs();
                 //   init_arr_cf_pastTo();
                    this.Hide();
                }
        ...
        private void ed_lvInfo_DoubleClick(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < ed_lvInfo.Items.Count; i++)
                for (int y = 0; y < ed_lvInfo.Items[i].SubItems.Count; y++)
                    arr_info[i, y] = ed_lvInfo.Items[i].SubItems[y].Text;
            ...
            for (int i = 0; i < ed_lvInfo.Items.Count; i++)
                for (int y = 0; y < ed_lvInfo.Items[i].SubItems.Count; y++)
                     ed_lvInfo.Items[i].SubItems[y].Text=arr_info[i, y] ;    
