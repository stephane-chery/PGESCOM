...
namespace PGESCOM
{
    class PXMS_group
    {
        ...
        private void init_arrCells()
        {
            ...
            string stSql = " Select Row_Name from PXMS_Param_Rows inner join PXMS_Grp_Param on PXMS_Grp_Param.GRPPA_LID = PXMS_Param_Rows.GRPPA_LID " +
                           " where PXMS_Grp_Param.G_Name='" + in_hdr + "' order by PXMS_Param_Rows.Rnk_inGrp";
