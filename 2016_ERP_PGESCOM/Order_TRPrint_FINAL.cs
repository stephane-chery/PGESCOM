    ...
    * */
		...
		private void Print_Head_Info_New()
		{
			...
			if (In_RDR.lbrdNm.Text !="" && In_RDR.lbrdNm.Text!=MainMDI.VIDE     ) 
			{
				...
				WPmsg("    Soft Ver: ",'b',false);WPmsg(In_RDR.lbrdSoftV.Text   ,'n',false);
				WPmsg("    Connected to: ",'b',false);WPmsg(In_RDR.lConTO.Text   ,'n',false);
				WPmsg("    Manual: ",'b',false);WPmsg(In_RDR.Lman.Text   ,'n',false);
			}
			WPmsg("\n\n",'n',false);
			//	ll
...
*/
		...
		private void Print2L_EQ_AL_OT()
		{
			...
			{ 
				if (i==0)
				{
                    ...
                    WPrint10Cols('N', true, "Description (Symbol) ", "Adjust", "Time", "Relay #", "Time Out", "Msg Latch", "Relay Latch", "Fail Safe", "DEL #", "Del Latch", " Comments ");
	
					//Print_HTBL10(true);
				}
				//print Requested values 
                WPrint10Cols('R', (In_RDR.MLV_EqAlrm.Items[i].ImageIndex == 8), In_RDR.MLV_EqAlrm.Items[i].SubItems[1].Text, In_RDR.MLV_EqAlrm.Items[i].SubItems[2].Text, In_RDR.MLV_EqAlrm.Items[i].SubItems[4].Text, In_RDR.MLV_EqAlrm.Items[i].SubItems[6].Text, In_RDR.MLV_EqAlrm.Items[i].SubItems[8].Text, In_RDR.MLV_EqAlrm.Items[i].SubItems[10].Text, In_RDR.MLV_EqAlrm.Items[i].SubItems[12].Text, In_RDR.MLV_EqAlrm.Items[i].SubItems[14].Text, In_RDR.MLV_EqAlrm.Items[i].SubItems[16].Text, In_RDR.MLV_EqAlrm.Items[i].SubItems[18].Text, In_RDR.MLV_EqAlrm.Items[i].SubItems[20].Text);
				//print Tested values 
				In_RDR.Refresh ();
				In_RDR.panel1.Refresh();
				In_RDR.pictureBox3.Refresh();
        ...
        private void Print2L_EQ_AL_OT_EMPTY()
        {
            ...
            for (int i = 0; i < nbItem; i++)
            {
                if (i == 0)
                {
                    ...
                    TQDET10_CR();
                    SamePg = true;
                    WPrint10Cols('N', true, "Description (Symbol) ", "Adjust", "Delay", "Relay #", "Time Out", "Msg Latch", "Relay Latch", "Fail Safe", "DEL #", "Del Latch", " Comments ");
        ...
        private void Print_all_Boards_()
        {
            ...
            for (int i = 0; i < nbItem; i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    WPrint6Cols('C', true, In_RDR.mdl_brds.Items[i].SubItems[1].Text, In_RDR.mdl_brds.Items[i].SubItems[2].Text, In_RDR.mdl_brds.Items[i].SubItems[3].Text, In_RDR.mdl_brds.Items[i].SubItems[4].Text, In_RDR.mdl_brds.Items[i].SubItems[5].Text);
                }
                else
                {
                    if (newP)
                    {
                        WPrint6Cols('N', true, In_RDR.mdl_brds.Items[i].SubItems[1].Text, In_RDR.mdl_brds.Items[i].SubItems[2].Text, In_RDR.mdl_brds.Items[i].SubItems[3].Text, In_RDR.mdl_brds.Items[i].SubItems[4].Text, In_RDR.mdl_brds.Items[i].SubItems[5].Text);
                       // WPrint5Cols('N', (In_RDR.lvIOTest.Items[i].ImageIndex == 8), In_RDR.lvIOTest.Items[i].SubItems[1].Text, In_RDR.lvIOTest.Items[i].SubItems[2].Text, In_RDR.lvIOTest.Items[i].SubItems[3].Text, In_RDR.lvIOTest.Items[i].SubItems[4].Text);
                        newP = false;
                    }
                    else WPrint6Cols('C', true, In_RDR.mdl_brds.Items[i].SubItems[1].Text, In_RDR.mdl_brds.Items[i].SubItems[2].Text, In_RDR.mdl_brds.Items[i].SubItems[3].Text, In_RDR.mdl_brds.Items[i].SubItems[4].Text, In_RDR.mdl_brds.Items[i].SubItems[5].Text);
                }
      ...
      //      TQdet.Columns[5].Width = 250;
        ...
        private void WPrint10Cols(char cod, bool chk, string Desc, string DV, string DY, string RY, string TO, string ML, string RL, string FS, string DN, string DL, string Cmnt)
		{
