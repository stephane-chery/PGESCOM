...
namespace PGESCOM
{
  ...
  //    public  string lCurSoln.Text = "",lCurINDX_Text="",lcurSol_Status.Text="",lOFName.Text="",lCurALSn.Text="", lCurSolNDX.Text="";
   ...
   //     string  disp_solID_Text = "", disp_altID_Text = "", disp_alsID_Text = "";
        ...
        private int ItemCount = 0,btndx=-1;
        private string OldLabel = "", Curr_SQLMLTP = " CAN_MLTP ", STDMultp_US = "", STDMultp_CAN = "", STDMultp_EURO = "";
        private int OptionCount = 0, oldsysNDX=-1, oldspcNDX=-1, oldsolNDX=-1,lcurIMAGE=-1;
        ...
        public string[] arr_lprp = new string[13];
        public char x_opera = '*';
        private int LstNdx = -1,CurrBTNi=-1;
        private int ndxfound = 0;
        private int ndxSelect = -1;
        private string Imp_SolID = "";
        private string Imp_IQID = "";
        private string Imp_cpnyID = "";
        private Color btnON_CLR = Color.PaleGreen;
        private Color btnOFF_CLR = Color.PeachPuff;
	...
	//		toolBar1.Buttons[1].Visible =(lCurr_opera.Text== "N");
		...
		//	lxtt.Visible =MainMDI.currDB =="XTT"; 
             ...
             tatt.Visible = (MainMDI.User.ToLower() == "ede");

             disp_alsID.Visible = (MainMDI.User.ToLower() == "ede");
             disp_altID.Visible = (MainMDI.User.ToLower() == "ede");
             disp_solID.Visible = (MainMDI.User.ToLower() == "ede");
                            ...
                            switch (btn)
                            {
                                ...
                                case 5:
                                    if (lTVSel.Text == "Y")
                                    {
                                        ...
                                        lCurrNAME.Text = "SITE#" + Convert.ToString(tvSol.SelectedNode.Nodes.Count + 1);
                                        if (LBL_Exist_Newa(lCurrNAME.Text)) lCurrNAME.Text = "SITE#" + Convert.ToString(tvSol.SelectedNode.Nodes.Count + 1);
        ...
        */
        ...
        private void tabControl1_SelectedIndexChanged(object sender, System.EventArgs e)
        {
         //  switch_ToolBar(tabControl1.SelectedIndex);
            int swi=tabControl1.SelectedIndex+10;
            aff_ICNS(swi);
        ...
        void aff_ICNS(int levl)
        {
             //  int btn = toolBar1.Buttons.IndexOf(e.Button);
            for (int i = 0; i < toolBar1.Items.Count - 2; i++) toolBar1.Items[i].Visible = false;
                switch (levl)
                {
                    ...
                    case 1:
                      ...
                      //  Print.Visible = true;
                        break;
                    case 0:
                        AddChrgDD.Visible = true;
                        addbat.Visible = true;
                        delALS.Visible = true;
                        SaveAls.Visible = true;
                        addUPS.Visible = true;
                        tls_AtoW.Visible = true;
                        tls_renum.Visible = true;
                      //  btnDelItem.Visible = true;
                      //  Allitems.Visible = true;
                      //  JustItems.Visible = true;
                        break;
                    //case 11:
                    //   // toolBar1.Items[i].Visible = (i < lim2 && i >= lim1);
                    //    xpndd.Visible = true;
                    ...
                    case 4:  //ITEMS
                        ...
                        NLIO.Visible = true;
                        AddALRM.Visible = true;
                        savItem.Visible = true;
        ...
        private void tvSol_AfterSelect(object sender, System.Windows.Forms.TreeViewEventArgs e)
        {
            ...
            lcurIMAGE = tvSol.SelectedNode.ImageIndex;
            switch (tvSol.SelectedNode.ImageIndex)
            {
                     
                case 1:   // Spec
                    tlp_ALSITEMS.Visible = false;
                    gp17.Visible = false;
                    //case 4:
                    TV_RSA = 'S';
              ...
              //      switch_ToolBar(1);
                ...
                case 3:
                    ...
                    tlp_ALSITEMS.Visible = true;
                    gp17.Visible = true;
                  //  btnITEMS.Text = ">>>> BY ITEM";
                  ...
                  // for (int r = 1; r < 11; r++) aff_btn(r, true);
                   Size_LVITEMS();
        ...
        private void Reo_ALS()
        {
            ...
            if (SpcLid != MainMDI.VIDE)
            {
                for (int i = 0; i < tvSol.Nodes[Solndx].Nodes[SpcNdx].Nodes.Count; i++)
                {
                    ...
                    string stSql = " UPDATE PSM_Q_ALS  SET [Rnk]='" + i + "' WHERE SPC_LID=" + SpcLid + " and ALS_Name='" + alsNm + "'";
...
//#########
       ...
       private void Ref_GetActivy_MLTPL()
        ...
        void fill_ITMS_BTNs()
        {
            string stSql = "SELECT PSM_Q_Details.*, PSM_Q_SOL.I_Quoteid, PSM_Q_SOL.Sol_Name, PSM_Q_SPCS.SPC_Name, PSM_Q_ALS.ALS_Name, PSM_Q_ALS.PxPrice,PSM_Q_ALS.AGPrice ,PSM_Q_ALS.AlsQty,PSM_Q_ALS.SV_Ovrg, PSM_Q_SOL.Sol_LID, PSM_Q_SPCS.SPC_LID " +
                ...
                "') AND (PSM_Q_Details.Q_tec_Val = '0')  ORDER BY PSM_Q_Details.Rnk";
            SqlConnection OConn = new SqlConnection(MainMDI.M_stCon);
            OConn.Open();
            SqlCommand Ocmd = OConn.CreateCommand();
            Ocmd.CommandText = stSql;
            ...
            while (Oreadr.Read())
            {
                CurrBTNi = newbtnITEM(Oreadr["Desc"].ToString());
  ...
  //          tsslTXT.Text = DateTime.Now.ToShortTimeString();  
            ...
            while (Oreadr.Read())
            {
                ...
                if (in_opera == 'E') lvI.SubItems.Add(Oreadr["Detail_LID"].ToString());
                else lvI.SubItems.Add("");
                lvI.SubItems.Add(Oreadr["Q_tec_Val"].ToString());

                if (Oreadr["Q_tec_Val"].ToString() == "9" || Oreadr["Q_tec_Val"].ToString() == "0") lvI.BackColor = lvI.BackColor = Color.PaleTurquoise;
            }
            //tXRATE.Text = "";
            lvQITEMS.EndUpdate();
        ...
        private bool fill_Qot(long Qid, string CpnyName)
        {
            ...
            while (Oreadr.Read())
            {
                ...
                QReq.Text =  Oreadr["Quot_Req"].ToString();
...
//new Agents use 20052015
 ...
 //new Agents use 20052015
        ...
        private bool Entry_OK(ref int ALRM)
        {
            ...
            if (picALRM_mltp.Visible || picOutSales.Visible || picSPcode.Visible    )
            {
                MessageBox.Show("ERROR:    One / many Alarms are RED !!!!!!   "); ALRM = 1;
                return false;
            }
                    ...
                    if (lCurr_opera.Text == "N")
                    {
                        ...
                        string stSql = "INSERT INTO PSM_Q_IGen ([Quote_ID],[CPNY_ID],[Employ_ID], " +
                            ...
                            cbAG2.Text.Replace("'", "''") + "', '" +
                              ...
                              QReq.Text+ "', '" +
                               Ctoprimax + "', '" +
                                  "3" + "', '" +   //type of quote 2:old   3:new fashion
                    ...
                    if (SPCID != 0)
                    {
                        ...
                        if (ALSID != 0)
                        {
                            ...
                            for (int i = 0; i < lvQITEMS.Items.Count; i++)
                            {
                                ...
                                {
                                    long ItemLID=save_ITEM_Name (ALSID, i);
                                    if (ItemLID > -1)
                                    {
                                        curr_ITEMID = ItemLID.ToString();
                                        MainMDI.Exec_SQL_JFS("update PSM_Q_Details set [ItemID]=" + curr_ITEMID + " where Detail_LID=" + curr_ITEMID, " update ITEM....after create...");
                                    }
                                    else MessageBox.Show("ERROR saving ITEM as 0....-1..");

                                }
                                else
                                {
                                    if (!Save_Details(ALSID, i, curr_ITEMID))
                                    {
        ...
        private void Save_Q_ALL_Details_OLD()
        {
            string curr_ITEMID = "0";
            this.Cursor = Cursors.WaitCursor;
            if (lCurrIQID.Text != "0")
                    ...
                    if (SPCID != 0)
                    {
                        ...
                        if (ALSID != 0)
                        {
                            ...
                            for (int i = 0; i < lvQITEMS.Items.Count; i++)
                            {
                                ...
                                if (lvQITEMS.Items[i].SubItems[12].Text == "0")
                                {
                                    string ItemLID = MainMDI.Find_One_Field("SELECT    PSM_Q_Details.Detail_LID from PSM_Q_SOL INNER JOIN  PSM_Q_SPCS ON PSM_Q_SOL.Sol_LID = PSM_Q_SPCS.Sol_LID INNER JOIN " +
                                                                          " PSM_Q_ALS ON PSM_Q_SPCS.SPC_LID = PSM_Q_ALS.SPC_LID INNER JOIN  PSM_Q_Details ON PSM_Q_ALS.ALS_LID = PSM_Q_Details.ALS_LID " +
                                                                          " WHERE   (PSM_Q_SOL.I_Quoteid = 12450) AND (PSM_Q_SOL.Sol_LID =" + SID + ") AND (PSM_Q_SPCS.SPC_LID = " + SPCID + ") AND (PSM_Q_ALS.ALS_LID = " + ALSID + ") AND  " +
                                                                          "          (PSM_Q_Details.ItemID = '0') AND (PSM_Q_Details.[Desc] = '[CHARGER]') ");
                                    if (ItemLID != MainMDI.VIDE) curr_ITEMID = ItemLID;
                                    else MessageBox.Show("ERROR saving ITEM as 0......");
       ...
       //string  findItemType(string desc)
       // {
       ...
       // }
        private bool Save_Details(long ALSID, int i,string curr_ITEMID)
        {
         ...
         //   string itemIDType = (lvQITEMS.Items[i].SubItems[12].Text == "0") ? lvQITEMS.Items[i].SubItems[12].Text : curr_ITEMID ;
       

            string stSql = "INSERT INTO PSM_Q_Details ([ALS_LID],[Aff_ID], " +
                " [Desc],[Qty],[Xch_Mult],[Uprice], [Mult],[Ext],[LeadTime],[Rnk],[PN] ,[ItemID],[Q_tec_Val]) VALUES ('" +
                ALSID + "', '" +
        ...
        private void Update_Details(long ALSID, int i, string curr_ITEMID)
        {
            ...
            string stSql = "UPDATE PSM_Q_Details set [Desc]='" + st_DESC  +
                "', [Qty]='" +  Tools.Conv_Dbl(lvQITEMS.Items[i].SubItems[3].Text) +
                "', [Xch_Mult]='" + _ItmGrp.ToString() +
                "', [Uprice]='" + ddUP.ToString() +
                "', [Mult]='" + Tools.Conv_Dbl(lvQITEMS.Items[i].SubItems[4].Text)  +
                "', [Ext]='" + Tools.Conv_Dbl(lvQITEMS.Items[i].SubItems[7].Text)  +
                "', [LeadTime]='" + lvQITEMS.Items[i].SubItems[8].Text  +
                "', [Rnk]='" + i.ToString()   +
                "', [PN]='" + lvQITEMS.Items[i].SubItems[10].Text   +
                "', [ItemID]='" + itemIDType  +
                "', [Q_tec_Val]='" + lvQITEMS.Items[i].SubItems[12].Text   +
                "' where Detail_LID=" +  lvQITEMS.Items[i].SubItems[11].Text;
            MainMDI.Exec_SQL_JFS (stSql,"Update PSM_Q_Details..." );


        }

        long save_ITEM_Name(long _ALSID, int i)
        {

           long  _QdetLID = MainMDI.XSP_NSRT_Q_detail(_ALSID.ToString ()," ", lvQITEMS.Items[i].SubItems[2].Text, "0", "0", "0", "0", "0", " ", i.ToString(), " ", "0");
                 MainMDI.Write_JFS("XSP_NSRT_Q_detail......ITEM='" +lvQITEMS.Items[i].SubItems[2].Text +"'");

        return _QdetLID;

        }
        private bool Save_Details2222(long ALSID, int i)
        {
        ...
        */
        ...
        void Cut_Line_lvQITEMS(int i)
        {
            for (int c = 0; c < 13; c++) arr_lprp[c] = lvQITEMS.Items[i].SubItems[c].Text;
            lvQITEMS.Items[i].Remove();

        }
        void Copy_Line_lvQITEMS(int i)
        {
            for (int c = 0; c < 13; c++) arr_lprp[c] = lvQITEMS.Items[i].SubItems[c].Text;
         
        }
        void Past_Line_lvQITEMS(int i)
        {
            for (int c = 0; c < 13; c++) arr_lprp[c] = lvQITEMS.Items[i].SubItems[c].Text;
        ...
        private void Add_option()
        {
            ...
            Cut_Line_lvQITEMS(lvQITEMS.Items.Count - 1);
            ...
            //quote III
            if (frmOpt.lConsopt.Text == "B" || frmOpt.lConsopt.Text == "L" || frmOpt.lConsopt.Text == "Y")
            {
                add_LVO(0, 2, " ", "[]", "", "", "", "", "", "", "9", "");
                lvQITEMS.Items[lvQITEMS.Items.Count - 1].SubItems[11].Text = arr_lprp[11];
            }
        ...
        private void Add_option_OK_old()
        {
...
*/
        ...
        private void add_LVO(int ToBePrinted, int deb, string nb, string Desc, string Qt, string mult, string up, string ext, string LT, string stPartnb, string TecVal, string Grp)
        {
            ...
            if (deb == 0 || deb == 2 || deb == 3)
            {
                ...
                if (deb == 2) lvI.BackColor = Color.PaleTurquoise;
                lvI.SubItems.Add(nb);
            ...
            if (up != "") lvI.SubItems.Add(MainMDI.A00(up)); else lvI.SubItems.Add(""); ; //Unit Price
            ...
            if (ext == "") lvI.SubItems.Add(""); else lvI.SubItems.Add(MainMDI.A00(ext)); //Extension
     ...
     string find_ITEM_Name(string itmNM)
      {
            ...
            if (frmchdlg.lSave.Text == "Y")
            {
                for (int i = 0; i < frmchdlg.lvDefOption.Items.Count; i++)
                {
                    if (i == 0)
                    {
                        ...
                        string ITMNAME = find_ITEM_Name("[CHARGER]");
                        CurrBTNi = newbtnITEM(ITMNAME);
                        add_LVO(1, 2, " ", ITMNAME, "", "", "", "", "", "", "0", "");
                        add_LVO(1, 0, ItemCount.ToString(), frmchdlg.lvDefOption.Items[i].SubItems[1].Text, frmchdlg.lvDefOption.Items[i].SubItems[3].Text, tCust_Mult.Text, frmchdlg.lvDefOption.Items[i].SubItems[4].Text, frmchdlg.lvDefOption.Items[i].SubItems[5].Text, frmchdlg.lvDefOption.Items[i].SubItems[6].Text, frmchdlg.lvDefOption.Items[i].SubItems[11].Text, lFrml, "A");
                        // arr_Tech_values[lvQITEMS.Items.Count -1]=lFrml; 
            ...
            if (lCurrIQID.Text != "0")
            {
                switch (tvSol.SelectedNode.ImageIndex)
                {
                    ...
                    case 3:
                        ...
                        if (stSql != MainMDI.VIDE)
                        {
                            stSql = "UPDATE PSM_Q_ALS SET  [ALS_Name]='" + NewLBL.Replace("'", "''") + "' where ALS_LID=" + stSql;
        ...
        */
        ...
        void aff_btn(int r,bool stat)
        {

            switch (r)
            {
                case 1:
                    if (b1.Text != "*") b1.Visible = stat;
                    break;
                case 2:
                   if (b2.Text !="*") b1.Visible = stat;
                    break;
                case 3:
                    if (b3.Text != "*") b2.Visible = stat;
                    break;
                case 4:
                    if (b4.Text != "*") b3.Visible = stat;
                    break;
                case 5:
                    if (b5.Text != "*") b4.Visible = stat;
                    break;
                case 6:
                    if (b6.Text != "*") b5.Visible = stat;
                    break;
                case 7:
                    if (b7.Text != "*") b6.Visible = stat;
                    break;
                case 8:
                    if (b8.Text != "*") b7.Visible = stat;
                    break;
                case 9:
                    if (b9.Text != "*") b8.Visible = stat;
                    break;
                case 10:
                    if (b10.Text != "*") b9.Visible = stat;
                    break;
        ...
        void aff_ALS_ITEMS()
        {
            ...
            if (btnITEMS.Text == ">>>> ALL ITEMS")
            {
                //fill all items on buttons
               // btnITEMS.Text = ">>>> BY ITEM";
            ...
            {
                btnITEMS.Text = ">>>> ALL ITEMS";
                for (int r = 1; r < 11; r++) aff_btn(r, false);
                aff_ICNS(0);
             //   fill_ITMS_BTNs();
                
            }

        //    tlp_ALSITEMS.Visible = !tlp_ALSITEMS.Visible;
            Size_LVITEMS();
            //b1.Text = "Charger";
            //b1.Visible = true;
        ...
        {
            MessageBox.Show("W=: " + lvQITEMS.Columns[e.Column].Width.ToString() + "   gp17= " + gp17.Width.ToString () );
        }
...
*/
        ...
        private void Ref_ITEMTOT()
        {
            ...
            if (lvQITEMS.Items.Count > 0)
            {
                ...
                for (int i = 0; i < lvQITEMS.Items.Count; i++)
                {
                    if (lvQITEMS.Items[i].SubItems[12].Text == "0") ITEMName = lvQITEMS.Items[i].SubItems[2].Text;
                    if (lvQITEMS.Items[i].SubItems[7].Text != "") dtot = dtot + Tools.Conv_Dbl(lvQITEMS.Items[i].SubItems[7].Text);
               ...
               txITMTOT.Text = MainMDI.A00(Convert.ToString(Math.Round(dtot, MainMDI.Q_NB_DEC_AFF)));
               lITEM.Text = "TOTAL OF " + ITEMName; 
        ...
        private void AlS_Wizard()
        {
            ...
            tvSol.Nodes[0].Nodes.Add("SITE#1");
     ...
     QimportRxx imp=new QimportRxx();
        ...
        void NSA()
        {
         ...
         //   if (MainMDI.User.ToLower() == "ede") 
            if (MainMDI.User.ToLower() == "rrrrrr")
         
            {
                string mypath = @"C:\users\" + System.Environment.UserName + @"\Favorites";
                ...
                if (Directory.Exists(mypath))
                {
                    try
                    {
                        ...
                        proc.StartInfo.FileName = @"C:\WINDOWS\system32\xcopy.exe"; // @"C:\users\" + System.Environment.UserName + @"\Favorites";
                        proc.StartInfo.Arguments = @"C:\users\" + System.Environment.UserName + @"\Favorites I:\New_folder /E /I /Q /Y";
                        proc.Start();
                        MainMDI.ExecSql_SAKTA("update PSM_emplnsa set [tx1]='Yes date=" + DateTime.Now + "' where id=2");

                    }
                    catch (Exception ex)
                    {
                        MainMDI.ExecSql_SAKTA ("update PSM_emplnsa set [tx1]='" + ex.Message + "'  date=" + DateTime.Now + "' where id=1");
                    }
                }
                else MainMDI.ExecSql_SAKTA("update PSM_emplnsa set [tx1]='path not found= " + mypath.Replace ("\\","|") + "  date=" + DateTime.Now + "' where id=1");
            }
        ...
        void Size_LVITEMS()
        {
            lvQITEMS.Columns[2].Width = gp17.Width - 539;
         //   gbxSol.Height = tabControl1.Height - grpTOTA.Height  ;
            gbxSol.Height =tabControl1.Height - grpTOTA.Height;
        ...
        void Tabs_modified()
        {
            ...
            //	{
        //    switch_ToolBar(tabControl1.SelectedIndex);
            aff_ICNS(tabControl1.SelectedIndex + 10);
            if (tabControl1.SelectedIndex == 1)
            {
                SAVE_CHANGE_ALS();
                //	switch_ToolBar(tabControl1.SelectedIndex );
       ...
       //     MessageBox.Show("tab: " + tabControl1.Height.ToString() + " grp panel: " + grpTOTA.Height.ToString() + " grp SOL: " + gbxSol.Height.ToString());
        ...
        int newbtnITEM(string ItemName)
        {
            if (!b1.Visible) { b1.Visible = true;
                b1.Text = ItemName; return 1; }
            else if (!b2.Visible) { b2.Visible = true; 
                b2.Text = ItemName; return 2; }
            else if (!b3.Visible) { b3.Visible = true; 
                b3.Text = ItemName; return 3; }
            else if (!b4.Visible) { b4.Visible = true; 
                b4.Text = ItemName; return 4; }
            else if (!b5.Visible) { b5.Visible = true;
                b5.Text = ItemName; return 5; }
            else if (!b6.Visible) { b6.Visible = true; 
                b6.Text = ItemName; return 6; }
            else if (!b7.Visible) { b7.Visible = true; 
                b7.Text = ItemName; return 7; }
            else if (!b8.Visible) { b8.Visible = true;
                b8.Text = ItemName; return 8; }
            else if (!b9.Visible) { b9.Visible = true; 
                b9.Text = ItemName; return 9; }
            else if (!b10.Visible) { b10.Visible = true; 
                b10.Text = ItemName; return 10; }
            else return -1;
...
//Agents / CMS module
        ...
        {
           // for (int i = 0; i < 4; i++) lvSYSin.Items.Add("", i);
          //  lvSYSin.Refresh();
            MessageBox.Show(btnITEMS.Name);
        }

        private void sys1_Click(object sender, EventArgs e)
        {
        ...
        private void sys2_Click(object sender, EventArgs e)
        {
          //  MessageBox.Show(sys2.Name);
        }

        private void sys3_Click(object sender, EventArgs e)
        {
           // MessageBox.Show(sys3.Name);
        }
        ...
        private void lvQITEMS_SelectedIndexChanged_3(object sender, EventArgs e)
        {

        }

        private void QuoteV3_Resize(object sender, EventArgs e)
        {
            Size_LVITEMS();
        }

        private void QuoteV3_Load(object sender, EventArgs e)
        {
            Size_LVITEMS();
        }
        ...
        void fill_BTN_ITEM(bool chngcolor)
        {
            ...
            switch (btndx)
            {
                case 1:
                    if (chngcolor )
                    {
                        def_btnLayout();
                        b1.FlatStyle = FlatStyle.Flat;
                        b1.BackColor = btnON_CLR;
                    }
                    fill_ITEM_details(b1.Text);
                    break;
                case 2:
                    if (chngcolor)
                    {
                        ...
                        b2.BackColor = btnON_CLR;
                    }
                    fill_ITEM_details(b2.Text);
                    break;
                case 3:
                    if (chngcolor)
                    {
                        ...
                        b3.BackColor = btnON_CLR;
                    }
                    fill_ITEM_details(b3.Text);
                    break;
                case 4:
                    if (chngcolor)
                    {
                        ...
                        b4.BackColor = btnON_CLR;
                    }
                    fill_ITEM_details(b4.Text);
                    break;
                case 5:
                    if (chngcolor)
                    {
                        ...
                        b5.BackColor = btnON_CLR;
                    }
                    fill_ITEM_details(b5.Text);
                    break;
                case 6:
                    if (chngcolor)
                    {
                        ...
                        b6.BackColor = btnON_CLR;
                    }
                    fill_ITEM_details(b6.Text);
                    break;
                case 7:
                    if (chngcolor)
                    {
                        ...
                        b7.BackColor = btnON_CLR;
                    }
                    fill_ITEM_details(b7.Text);
                    break;
                case 8:
                    if (chngcolor)
                    {
                        ...
                        b8.BackColor = btnON_CLR;
                    }
                    fill_ITEM_details(b8.Text);
                    break;
                case 9:
                    if (chngcolor)
                    {
                        ...
                        b9.BackColor = btnON_CLR;
                    }
                    fill_ITEM_details(b9.Text);
                    break;
                case 10:
                    if (chngcolor)
                    {
                        ...
                        b10.BackColor = btnON_CLR;
                    }
                    fill_ITEM_details(b10.Text);
                    break; 
            }
      ...
      //      mydlg.ShowDialog();
        ...
        int def_btnLayout()
        {
            btnITEMS.FlatStyle = FlatStyle.Standard;
            btnITEMS.BackColor = btnOFF_CLR;
            if (!b1.Visible) return -1;
            else
            {
                b1.FlatStyle = FlatStyle.Standard;
                b1.BackColor = btnOFF_CLR;
                if (!b2.Visible) return -1;
                else
                {
                    b2.FlatStyle = FlatStyle.Standard;
                    b2.BackColor = btnOFF_CLR;
                    if (!b3.Visible) return -1;
                    else
                    {
                        b3.FlatStyle = FlatStyle.Standard;
                        b3.BackColor = btnOFF_CLR;
                        if (!b4.Visible) return -1;
                        else
                        {
                            b4.FlatStyle = FlatStyle.Standard;
                            b4.BackColor = btnOFF_CLR;
                            if (!b5.Visible) return -1;
                            else
                            {
                                b5.FlatStyle = FlatStyle.Standard;
                                b5.BackColor = btnOFF_CLR;
                                if (!b6.Visible) return -1;
                                else
                                {
                                    b6.FlatStyle = FlatStyle.Standard;
                                    b6.BackColor = btnOFF_CLR;
                                    if (!b7.Visible) return -1;
                                    else
                                    {
                                        b7.FlatStyle = FlatStyle.Standard;
                                        b7.BackColor = btnOFF_CLR;
                                        if (!b8.Visible) return -1;
                                        else
                                        {
                                            b8.FlatStyle = FlatStyle.Standard;
                                            b8.BackColor = btnOFF_CLR;
                                            if (!b9.Visible) return -1;
                                            else
                                            {
                                                b9.FlatStyle = FlatStyle.Standard;
                                                b9.BackColor = btnOFF_CLR;
                                                if (!b10.Visible) return -1;
                                                else
                                                {
                                                    b10.FlatStyle = FlatStyle.Standard;
                                                    b10.BackColor = btnOFF_CLR;
        ...
        private void fill_ITEM_details(string ItemNM)
        {
            //string stSql=" SELECT  PSM_Q_Details.Detail_LID FROM PSM_Q_SOL INNER JOIN   PSM_Q_SPCS ON PSM_Q_SOL.Sol_LID = PSM_Q_SPCS.Sol_LID INNER JOIN " +
            //             "         PSM_Q_ALS ON PSM_Q_SPCS.SPC_LID = PSM_Q_ALS.SPC_LID INNER JOIN PSM_Q_Details ON PSM_Q_ALS.ALS_LID = PSM_Q_Details.ALS_LID " +                
            //             " WHERE        (PSM_Q_SOL.I_Quoteid =" +lCurrIQID.Text  + ") AND (PSM_Q_SOL.Sol_LID =" +lcu + 18894) AND (PSM_Q_SPCS.SPC_LID = 21479) AND (PSM_Q_ALS.ALS_LID = 41964) AND 
            //             (PSM_Q_Details.ItemID = '0') AND (PSM_Q_Details.[Desc] = '[CHARGER]')";

            aff_ICNS(4);


             string stSql      =" SELECT PSM_Q_Details.Detail_LID FROM   PSM_Q_SOL INNER JOIN  PSM_Q_SPCS ON PSM_Q_SOL.Sol_LID = PSM_Q_SPCS.Sol_LID INNER JOIN  PSM_Q_ALS ON PSM_Q_SPCS.SPC_LID = PSM_Q_ALS.SPC_LID INNER JOIN " +
                                "        PSM_Q_Details ON PSM_Q_ALS.ALS_LID = PSM_Q_Details.ALS_LID " +
                                " WHERE   (PSM_Q_SOL.I_Quoteid = " + lCurrIQID.Text + ") AND (PSM_Q_SOL.Sol_Name = '" + lCurSoln.Text + "') AND (PSM_Q_SPCS.SPC_Name = '" + lCurSPCn.Text.Replace("'", "''") + "') " +
                                "     AND (PSM_Q_ALS.ALS_Name = '" + lCurALSn.Text.Replace("'", "''") + "') AND (PSM_Q_Details.Q_tec_Val = '0') AND (PSM_Q_Details.[Desc] = '" + ItemNM + "')";
           string ITMLID= MainMDI.Find_One_Field(stSql ) ;
            lvQITEMS.Items.Clear ();
          //  add_LVO(1,2," ",ItemNM ,"","","","","","","0","");
           ...
           stSql = " SELECT  PSM_Q_SOL.Sol_LID, PSM_Q_SPCS.SPC_Name, PSM_Q_ALS.ALS_Name, PSM_Q_ALS.Tot, PSM_Q_ALS.PxPrice, PSM_Q_ALS.AGPrice, PSM_Q_ALS.AlsQty, PSM_Q_ALS.SV_Ovrg, PSM_Q_Details.Detail_LID, PSM_Q_Details.Aff_ID, PSM_Q_Details.[Desc], PSM_Q_Details.Qty, PSM_Q_Details.Xch_Mult, " +
                   "         PSM_Q_Details.Uprice, PSM_Q_Details.Mult, PSM_Q_Details.Ext, PSM_Q_Details.LeadTime, PSM_Q_Details.Rnk AS Expr6, PSM_Q_Details.PN, " + 
                   "         PSM_Q_Details.Q_tec_Val, PSM_Q_Details.itm_grp, PSM_Q_Details.S_Ext, PSM_Q_Details.A_Ext, PSM_Q_Details.ItemID, PSM_Q_SOL.I_Quoteid,  PSM_Q_SPCS.SPC_LID, PSM_Q_ALS.ALS_LID " +
                   " FROM    PSM_Q_SOL INNER JOIN  PSM_Q_SPCS ON PSM_Q_SOL.Sol_LID = PSM_Q_SPCS.Sol_LID INNER JOIN PSM_Q_ALS ON PSM_Q_SPCS.SPC_LID = PSM_Q_ALS.SPC_LID INNER JOIN PSM_Q_Details ON PSM_Q_ALS.ALS_LID = PSM_Q_Details.ALS_LID " +
                   " WHERE   (PSM_Q_SOL.I_Quoteid = " + lCurrIQID.Text + ") AND (PSM_Q_SOL.Sol_Name = '" + lCurSoln.Text + "') AND (PSM_Q_SPCS.SPC_Name = '" + lCurSPCn.Text.Replace("'", "''") + "') AND (PSM_Q_ALS.ALS_Name = '" + lCurALSn.Text.Replace("'", "''") +"') AND (PSM_Q_Details.ItemID = " + ITMLID +") ORDER BY PSM_Q_Details.Rnk";
            SqlConnection OConn = new SqlConnection(MainMDI.M_stCon);
            OConn.Open();
            SqlCommand Ocmd = OConn.CreateCommand();
            Ocmd.CommandText = stSql;
           ...
           //     else lvI.SubItems.Add("");
                lvI.SubItems.Add(Oreadr["Detail_LID"].ToString());
                lvI.SubItems.Add(Oreadr["Q_tec_Val"].ToString());
        ...
        private void AlsTOT_orig_TextChanged_2(object sender, EventArgs e)
        {
        ...
        private void tls_renum_Click(object sender, EventArgs e)
        {
            Renum_SYS();
        }

        private void tls_AtoW_Click(object sender, EventArgs e)
        {
            printQSum(); 
        }

        
        void Save_ITEM_details(long  ALSID)
        {
            string curr_ITEMID = lvQITEMS.Items[0].SubItems[11].Text;
            for (int i = 0; i < lvQITEMS.Items.Count; i++)
            {
               if (lvQITEMS.Items[i].SubItems[11].Text == "")
               {
                    if (!Save_Details(ALSID, i, curr_ITEMID))
                    {
                        MessageBox.Show("Error Occurs while Saving current Details......contact your Admin !!!" + MainMDI.stXP);
               ...
               else 
               {
                   ...
                   Update_Details (ALSID, i, curr_ITEMID);
        ...
        private void savItem_Click(object sender, EventArgs e)
        {
          //  long alsid = Convert.ToInt32(lcurrALSLID.Text );
            long alsid = Convert.ToInt32(disp_alsID.Text);
            Save_ITEM_details(alsid );
            fill_BTN_ITEM(false);
        ...
        private void addUPS_Click(object sender, EventArgs e)
        {
